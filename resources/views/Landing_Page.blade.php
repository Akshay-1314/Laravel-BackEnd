  ...
  <html lang="en-US">
    ...
    <body>
      ...
      <div class="container-fluid" id="diagnostic">
        <a href="booking_page" class="btn btn-secondary btn-outline-dark text-white op mar">
          ...
          <div class="container">-->
              <div class="row mb-5">
                  <div class="col-5 bg-secondary mt-4 mx-auto">
                      <span class="display-5 text-warning fea shadow rounded">FEATURES</span>
                      <ul class="text-white">
      ...
      @endif
      <footer class=" bg-secondary" id="footer"><h4 class="text-warning" id="about"><span class="shadow rounded">World's Largest Healthcare</span></h4>
      <div class="text-white">
        ...
        <br/>
        <h6 class="text-warning"><span class="shadow rounded">Social Media</span></h6>
        <nav>
